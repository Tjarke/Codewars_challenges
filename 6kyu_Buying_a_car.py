...
def nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth):
    ...
    while available < 0:
        ...
        if cnt%2 == 0:
            pcloss += 0.5
        startPriceOld = startPriceOld*(1-pcloss/100)
        startPriceNew = startPriceNew*(1-pcloss/100)  
        available = startPriceOld - startPriceNew + savingperMonth*cnt
    return [cnt,round(available)]